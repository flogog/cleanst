 ...
 */
public class CleanstMapSuggestion extends Fragment implements LocationListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_map_suggestion, container, false);
    ...
    private void getLocationsFirebase() {
        Firebase myFirebaseRef = new Firebase(getString(R.string.firebase_database_suggestions));
        ...
        queryRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    com.flogog.cleanst.pojo.Location loc = new com.flogog.cleanst.pojo.Location();
    ...
    private void drawMarker(com.flogog.cleanst.pojo.Location location) {
